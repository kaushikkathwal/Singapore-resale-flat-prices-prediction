...
with col2:
    st.markdown("<h1 style='text-align:right; color:black;'>Singapore Resale Flat Prices Prediction</h1>", unsafe_allow_html=True)
...
if selected=="HOME":
    ...
    with col2:
        ...
        if selected=="Technologies Used":
            ...
            st.header(":white[**4.Machne Learning with Scikit-learn**]")
...
if selected=="EXPLORE DATA":
    ...
    os.chdir(r"E:\data science\Singapore  Resale Flat Prices Predicting")
...
if selected=="Prediction":
    ...
    with col2:
        ...
        # storey range input
        # Upper
        storey_upper = st.number_input("**Enter the upper bound of the storey range**", value=6)
    ...
    if st.button('Predict Price'):
        import pickle
        with open(r"E:\data science\Singapore  Resale Flat Prices Predicting/model.pkl", 'rb') as file:
            loaded_model = pickle.load(file)
        new_pred = loaded_model.predict(features_df)[0]
        st.write('## :black[Predicted Resale price:] ', new_pred)
